...
4. If you click on the left button, the colorization process will be called. After a few minutes, you will get a result like below. The left image will be the original one, and the right image will be the colorized one so that you can get a comparison and enjoy it.
